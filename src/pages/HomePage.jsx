    ...
    return (
        <>
            ...
            <div className='p-6 flex justify-between items-center w-full max-w-3xl mx-auto'>
                ...
                <button className="bg-gradient-to-r from-blue-400 to-blue-600 text-white px-4 py-2 rounded-lg shadow-md hover:scale-105 transition"
                ...
                <table className="w-full border min-w-[700px] md:min-w-0">
                    <thead>
                        <tr className='bg-blue-100'>
                            <th className='p-2 border hover:bg-blue-200 transition'>Title</th>
