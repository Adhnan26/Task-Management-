    ...
    return (
        <>
            <div style={{background: "linear-gradient(to bottom right, #bfdbfe, #60a5fa)"}}>
                <h1 className='text-2xl font-bold font-serif text-center p-4'>Task Management 📋</h1>
            </div>

                <form
                    className="bg-blue-50 shadow-xl rounded-xl p-6 w-full max-w-3xl mx-auto mt-10 border"
                    onSubmit={(e) => handleCreate(e, navigate)}
                >
                    <h1 className='md:text-3xl text-2xl font-semibold mb-4'>Create Task📝</h1>

                    <label className='font-medium md:text-xl'>Title:</label>
                    ...
                    <label className='font-medium md:text-xl'>Description:</label>
                    ...
                    <label className='font-medium md:text-xl'>Status:</label>
                    ...
                    <div className="flex justify-end gap-4 mt-4">
                        <button
                            type="button"
                            className="px-6 py-2 rounded-lg bg-blue-500 text-white hover:bg-blue-700 transition-transform hover:scale-105"
                            onClick={() => {
